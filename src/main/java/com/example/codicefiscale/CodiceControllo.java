...
public class CodiceControllo {
    ...
    public static String codiceControllo(String s) {
        String c = "";
        String caratteri_posPari = "";
        String caratteri_posDispari = "";
        int counter = 0;
        for(int i = 0; i < s.length(); i++){
            if((i+1) % 2 == 0)
                caratteri_posPari += s.charAt(i);//perchè per l'algoritmo la stringa comincia da 1 e non da 0
            else
                caratteri_posDispari += s.charAt(i);
        }
        for(int i=0;i<caratteri_posDispari.length();i++){
            switch(caratteri_posDispari.charAt(i)){
        ...
        for(int i=0;i<caratteri_posPari.length();i++){
            switch(caratteri_posPari.charAt(i)){
